...
let AuthController = class AuthController {
    ...
    usersService;
    orgsService;
    constructor(authService, usersService, orgsService) {
    ...
    async createOrganization(req, name) {
        if (!name) {
            throw new common_1.UnauthorizedException('Organization name is required');
        }
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)('create-organization'),
    __param(0, (0, common_1.Request)()),
